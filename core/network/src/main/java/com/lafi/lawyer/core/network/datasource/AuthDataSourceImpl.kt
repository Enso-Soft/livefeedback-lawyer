...
class AuthDataSourceImpl @Inject constructor(
    ...
    override suspend fun postLoginSocial(requestBody: AuthLoginSocialRequest): NetworkResult<AuthLoginSocial> {
        return safeApiCall(networkJson) { authApi.postAuthLoginSocial(requestBody).toData() }
    }

    override suspend fun postSmsVerifyCode(requestBody: SmsVerifyCodeRequest): NetworkResult<SmsVerifyCode> {
